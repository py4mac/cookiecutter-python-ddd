...
from {{cookiecutter.app_name}}.entities import Experiment, ExperimentCreate
...
class ExperimentService(object):
    ...
    async def create_experiment(self, entity: ExperimentCreate,) -> Experiment:
        ...
        :param entity: :py:class:`{{cookiecutter.app_name}}.entities.ExperimentCreate` entity
    ...
    async def get_experiment_by_uuid(self, uuid: str) -> List[Experiment]:
        ...
        :return: A list :py:class:`{{cookiecutter.app_name}}.entities.Experiment` entities
        """
