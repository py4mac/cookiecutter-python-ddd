from {{cookiecutter.app_name}}.services.store.registry import StoreRegistry
...
class ExperimentStoreRegistry(StoreRegistry):
    ...
    def __init__(self):
        super(ExperimentStoreRegistry, self).__init__("{{cookiecutter.app_name}}.experiment_store")
    ...
    def get_store(self, experiment_uri=None):
        ...
        :return: An instance of `{{cookiecutter.app_name}}.services.store.experiment.AbstractStore` that fulfills the store URI
                 requirements.
        """
